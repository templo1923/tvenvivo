        ...
        <div class="header-content">
            ...
            <div class="header-search">
                ...
                <div class="header-search-form" id="header-search-form">
                    ...
                    <button class="header-search-close" id="header-search-close"><i class="fas fa-times"></i></button>
    ...
    <div class="container">
        <div class="player-container" id="player-container">
            <div id="video-player">
                ...
                <div class="error-message" id="error-message">Error al cargar el canal. Intenta nuevamente.</div>
            ...
            <div class="channel-info">
                <h3>Información del Canal <span class="live-indicator-small" id="live-indicator-small" style="display: none;"><i class="fas fa-circle"></i> EN VIVO</span></h3>
        ...
        <div class="control-buttons">
            <button class="control-button" id="toggle-channels-btn"><i class="fas fa-list"></i> Mostrar Canales</button>
            <button class="control-button favorites" id="toggle-favorites-btn"><i class="fas fa-heart"></i> Ver Favoritos</button>
            <button class="control-button share-button" id="share-channel-btn"><i class="fas fa-share-alt"></i> Compartir Canal</button>
            <button class="control-button playlist-button" id="manage-playlists-btn"><i class="fas fa-list-ol"></i> Listas de Reproducción</button>
        </div>
        ...
        <div id="notifications-panel" class="notifications-panel" style="display: none;">
            ...
            <button id="push-subscribe" class="control-button"><i class="fas fa-bell"></i> Activar Notificaciones</button>
            <button id="push-unsubscribe" class="control-button" style="display: none;"><i class="fas fa-bell-slash"></i> Desactivar Notificaciones</button>
        </div>

<div class="view-toggle" id="view-toggle">
            <button class="view-toggle-btn active" data-view="grid"><i class="fas fa-th"></i> Cuadrícula</button>
            <button class="view-toggle-btn" data-view="list"><i class="fas fa-list"></i> Lista</button>
        </div>

        <div class="channels-layout-container">
    ...
    <div class="floating-button" id="back-to-player"><i class="fas fa-arrow-up"></i></div>
    <button class="sports-info-btn" id="sports-info-btn"><i class="fas fa-info"></i></button>
    <button id="install-button" class="install-button"><i class="fas fa-download"></i> Instalar App</button>
    ...
    <div class="modal-overlay" id="share-modal">
        <div class="modal-content">
            ...
            <div class="share-options">
                ...
                <button class="control-button" id="copy-share-url"><i class="fas fa-copy"></i> Copiar Enlace</button>
                <div class="social-share-buttons">
                    <button class="social-share-btn whatsapp" data-platform="whatsapp"><i class="fab fa-whatsapp"></i></button>
                    <button class="social-share-btn facebook" data-platform="facebook"><i class="fab fa-facebook"></i></button>
                    <button class="social-share-btn twitter" data-platform="twitter"><i class="fab fa-twitter"></i></button>
                    <button class="social-share-btn telegram" data-platform="telegram"><i class="fab fa-telegram"></i></button>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="playlist-container">
                <div class="create-playlist">
                    ...
                    <button class="control-button" id="create-playlist-btn"><i class="fas fa-plus"></i> Crear</button>
                </div>
